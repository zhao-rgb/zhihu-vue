<template>
	<div>
		<div v-for="(item, index) in recommenedList" :key="index" class="card border-bottom fill-white p-4">
			...
			<div class="d-flex p-4" v-if="item.target.thumbnail">
			...
			<ul class="sticky-bar d-flex align-items-center p-2" >
